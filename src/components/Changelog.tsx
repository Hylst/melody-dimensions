...
const changelogData: ChangelogItem[] = [
  ...
  },
  {
    ...
    changes: [
      {
        type: "fix",
        description: "Correction du problème de défilement dans la section Genres Principaux avec un système de références aux éléments"
      },
      {
        type: "feature",
        description: "Enrichissement complet des contenus pour les 7 périodes musicales (Médiévale, Renaissance, Baroque, Classique, Romantique, Moderne, Contemporaine)"
      },
      {
        type: "improvement",
        description: "Restructuration de la navigation dans les sections avec une meilleure gestion des onglets et des défilements"
      },
      {
        type: "update",
        description: "Harmonisation des identifiants pour les sections de genres musicaux afin d'assurer une navigation cohérente"
      }
    ]
  }
];
