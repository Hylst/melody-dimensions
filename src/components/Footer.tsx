...
const Footer = () => {
  return (
    <footer className="bg-dark-purple text-white py-12 px-8 md:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div>
          <h4 className="font-semibold mb-4 uppercase tracking-wide text-primary-purple">Explorer</h4>
        ...
        <div>
          <h4 className="font-semibold mb-4 uppercase tracking-wide text-primary-purple">Informations</h4>
          <ul className="space-y-3 text-gray-300 text-sm">
        ...
        <div>
          <h4 className="font-semibold mb-4 uppercase tracking-wide text-primary-purple">Contact</h4>
          ...
          <div className="flex space-x-5 mt-4 text-gray-300 text-lg">
