...
import { Search, Menu, X, Newspaper, LinkIcon, BookOpen, Headphones } from "lucide-react";
...
export function MainNavigation() {
  ...
  const navigation = [
    ...
    { name: "Glossaire", href: "/glossaire", icon: BookOpen },
    { name: "Tutoriels", href: "/technique/tutoriels", icon: Headphones },
  ];
